...
process.env["GRIFFIN_TEST_HOME"] = testHome

// Set test managed config directory to isolate tests from system managed settings
const testManagedConfigDir = path.join(dir, "managed")
process.env["GRIFFIN_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
...
const cacheDir = path.join(dir, "cache", "griffin")
...
// and never hit the network. With GRIFFIN_DISABLE_MODELS_FETCH set, ModelsDev.Data
...
process.env["GRIFFIN_DISABLE_MODELS_FETCH"] = "true"

// Disable builtin plugins that aren't published to npm (@griffin/anthropic-auth, etc.)
process.env["GRIFFIN_DISABLE_DEFAULT_PLUGINS"] = "true"

// Disable bundled skills to isolate skill discovery tests
process.env["GRIFFIN_DISABLE_BUNDLED_SKILLS"] = "true"
...
process.env["GRIFFIN_API_BASE"] = "http://127.0.0.1:9"
