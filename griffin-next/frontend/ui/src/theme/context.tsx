...
const STORAGE_KEYS = {
  THEME_ID: "griffin-theme-id",
  COLOR_SCHEME: "griffin-color-scheme",
  THEME_CSS_LIGHT: "griffin-theme-css-light",
  THEME_CSS_DARK: "griffin-theme-css-dark",
} as const

const THEME_STYLE_ID = "griffin-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("griffin-theme-preload")?.remove()
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "griffin",
