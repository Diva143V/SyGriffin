...
/**
 * Banner shown when the local Griffin server is confirmed unreachable
    ...
    <Show when={server.healthy() === false}>
      ...
      >
        ...
        <div style={{ flex: 1, "min-width": 0 }}>
          ...
          >
            Can't reach your local Griffin server
          </div>
          <div
            style={{
          ...
          >
            {server.name} · start it with <code>griffin web</code> or switch servers · retrying…
          </div>
        </div>
        <button
          type="button"
