...
const DISMISS_KEY = "griffin.fda.banner.hidden"
...
const STEP_BODY: Record<"mac" | "win" | "linux", string> = {
  mac: "macOS blocks ~/Desktop · ~/Documents · ~/Downloads from any process that doesn't have Full Disk Access. Add the Griffin binary itself to the FDA list so it works from any shell.",
  win: "Run Griffin from Windows Terminal / PowerShell, not a sandboxed Microsoft Store shell.",
  linux: "Run Griffin from a system shell, not a confined Snap/Flatpak terminal.",
}
        ...
        <Show when={props.os === "mac"}>
          ...
          >
            ...
            <li>
              ...
              <code style={kbd()}>/opt/homebrew/bin/griffin</code>, hit Enter, Open
            </li>
            <li>Toggle the Griffin entry on</li>
            <li>Restart Griffin (kill + relaunch), then recheck below</li>
          </ol>
        </Show>
