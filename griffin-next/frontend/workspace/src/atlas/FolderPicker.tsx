 ...
 *
 * Backed by Griffin's /file endpoint, which walks the real filesystem
                      ...
                      <Show when={(entries() ?? []).length === 0} fallback={<span>nothing matches the filter</span>}>
                        ...
                        >
                          ...
                          <span style={{ "max-width": "360px", "line-height": 1.5 }}>
                            ...
                            <code>griffin</code> binary. For now, paste the absolute path of the folder you want
                            into the <em>go to</em> bar above — Griffin can still open any path you give it.
                          </span>
                        </Show>
                      </Show>
                    </div>
