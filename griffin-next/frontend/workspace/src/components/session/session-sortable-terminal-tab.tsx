    ...
    >
      <div class="relative h-full">
        <Tabs.Trigger
          ...
          class="!shadow-none"
          classes={{
            button: "border-0 outline-none focus:outline-none !shadow-none",
          }}
          closeButton={
            <IconButton
              icon="close"
        ...
        <Show when={store.editing}>
          <div class="absolute inset-0 flex items-center px-3 bg-surface-raised-strong z-10 pointer-events-auto">
            <input
              ...
              class="bg-transparent border-none outline-none text-14-regular min-w-0 flex-1"
            />
          </div>
        </Show>
