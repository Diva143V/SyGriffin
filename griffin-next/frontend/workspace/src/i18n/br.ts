export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos dos seus provedores conectados",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Griffin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Griffin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Griffin.",
  ...
  "dialog.plugins.empty": "Plugins configurados em griffin.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Griffin este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Griffin ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Griffin",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (griffin.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Griffin ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Griffin inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Griffin",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Griffin aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Griffin é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Griffin iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Griffin.",
