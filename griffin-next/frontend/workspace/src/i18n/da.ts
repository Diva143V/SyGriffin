export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller fra dine forbundne udbydere",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Griffin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Griffin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Griffin.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i griffin.json",
  ...
  "dialog.server.description": "Skift hvilken Griffin-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Griffin ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Griffin-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (griffin.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, Griffin understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Griffin inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Griffin",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Griffin ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Griffin er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Griffin starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Griffin.",
