export const dict = {
  ...
  "provider.connect.apiKey.description":
    "enter your {{provider}} API key to connect your account and use {{provider}} models in Griffin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Griffin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Griffin.",
  ...
  "dialog.plugins.empty": "plugins configured in griffin.json",
  ...
  "dialog.server.description": "switch which Griffin server this app connects to.",
  ...
  "toast.update.description": "a new version of Griffin ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "please report this error to the Griffin team",
  ...
  "error.chain.checkConfig": "check your config (griffin.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. note, Griffin does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Griffin includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "change the display language for Griffin",
  "settings.general.row.appearance.title": "appearance",
  "settings.general.row.appearance.description": "customise how Griffin looks on your device",
  "settings.general.row.theme.title": "theme",
  "settings.general.row.theme.description": "customise how Griffin is themed.",
