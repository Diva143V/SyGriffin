export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Griffinで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してGriffinで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Griffinで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "griffin.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するGriffinサーバーを切り替えます。",
  ...
  "toast.update.description": "Griffinの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをGriffinチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (griffin.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: GriffinはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Griffinには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Griffinの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのGriffinの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Griffinのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Griffin の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Griffin は最新バージョンです。",
