...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Griffin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Griffin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Griffin.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i griffin.json",
  ...
  "dialog.server.description": "Bytt hvilken Griffin-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Griffin ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Griffin-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (griffin.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Griffin ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Griffin inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Griffin",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Griffin ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Griffin er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Griffin starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Griffin.",
