export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele od Twoich połączonych dostawców",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Griffin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Griffin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Griffin.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w griffin.json",
  ...
  "dialog.server.description": "Przełącz serwer Griffin, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Griffin ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Griffin",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (griffin.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Griffin nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Griffin zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Griffin",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Griffin na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Griffin.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Griffin",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Griffin.",
