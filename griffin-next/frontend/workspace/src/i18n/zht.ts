...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Griffin 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Griffin 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Griffin 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 griffin.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Griffin 伺服器。",
  ...
  "toast.update.description": "Griffin 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Griffin 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (griffin.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Griffin 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Griffin 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Griffin 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Griffin 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Griffin 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Griffin 啟動時自動檢查更新",
