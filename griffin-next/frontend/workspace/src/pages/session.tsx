...
import RunsPage from "@/atlas/RunsPage"
...
export default function Page(): JSX.Element {
  ...
  const [visitedRuns, setVisitedRuns] = createSignal(false)
  createEffect(() => {
    if (centerTabs.active() === "runs") setVisitedRuns(true)
  })
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* runs — persisted scientific workflow records */}
            <Show when={visitedRuns()}>
              <div
                style={{
                  display: centerTabs.active() === "runs" ? "flex" : "none",
                  flex: 1,
                  "min-height": 0,
                  "flex-direction": "column",
                }}
...
function CenterTabStrip(props: { chatTitle: string }): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <CenterTab active={active() === "runs"} label="Runs" onClick={() => centerTabs.setActive("runs")}>
        <IconActivity size={12} strokeWidth={1.6} />
      </CenterTab>
